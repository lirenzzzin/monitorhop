...
use crate::connect::MonitorHopConnection;
...
fn to_capture_pos(pos: monitorhop_ipc::Position) -> input_capture::Position {
    match pos {
        monitorhop_ipc::Position::Left => input_capture::Position::Left,
        monitorhop_ipc::Position::Right => input_capture::Position::Right,
        monitorhop_ipc::Position::Top => input_capture::Position::Top,
        monitorhop_ipc::Position::Bottom => input_capture::Position::Bottom,
    }
}

fn to_proto_pos(pos: input_capture::Position) -> monitorhop_proto::Position {
    match pos {
        input_capture::Position::Left => monitorhop_proto::Position::Left,
        input_capture::Position::Right => monitorhop_proto::Position::Right,
        input_capture::Position::Top => monitorhop_proto::Position::Top,
        input_capture::Position::Bottom => monitorhop_proto::Position::Bottom,
    }
}
