...
use crate::listen::{ListenEvent, ListenerCreationError, MonitorHopListener};
                ...
                e = self.listener.next() => {match e {
                    ...
                    Some(ListenEvent::Clipboard {
                        ...
                        if receive_ok {
                            ...
                            log::debug!(
                                "rejecting clipboard transfer {transfer_id} from {addr}: \
                                 clipboard_receive disabled or unauthorized peer"
                            );
                        }
                        self.listener
                            .reply_clipboard_ack(
...
impl EmulationTask {
    ...
    async fn do_emulation_session(
        ...
        // display size until monitorhop is quit.
...
fn to_ipc_pos(pos: Position) -> monitorhop_ipc::Position {
    match pos {
        Position::Left => monitorhop_ipc::Position::Left,
        Position::Right => monitorhop_ipc::Position::Right,
        Position::Top => monitorhop_ipc::Position::Top,
        Position::Bottom => monitorhop_ipc::Position::Bottom,
    }
}
